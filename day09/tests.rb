...
assert_equal('[0,*]', DoubleLinkedCircularList.new.insert(0).insert(nil).to_s)
assert_equal(nil, DoubleLinkedCircularList.new.read)
assert_equal(nil, DoubleLinkedCircularList.new.insert(0).insert(nil).read)
...
assert_equal(0, DoubleLinkedCircularList.new.delete.length)
assert_equal(1, DoubleLinkedCircularList.new.insert(0).length)
assert_equal(2, DoubleLinkedCircularList.new.insert(0).insert(1).length)
assert_equal(1, DoubleLinkedCircularList.new.insert(0).insert(1).insert(2).delete.delete.length)
